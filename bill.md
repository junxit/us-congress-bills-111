...
This Act may be cited as the “Josh Miller Helping Everyone Access Responsive Treatment in Schools Act of 2009” or the “Josh Miller HEARTS Act”.
...
- **(a)** *Program required* The Secretary of Education shall carry out a program under which the Secretary makes grants to local educational agencies, to be used by the local educational agencies for one or both of the following:
  - **(1)** To purchase automated external de­fi­bril­la­tors for use in elementary and secondary schools served by the local educational agency.
