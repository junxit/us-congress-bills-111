...
>   - **(2)** Create a centralized portal or website utilized by each such agency to make the inventory of the bands of such agency available to the public via an Internet-accessible website.
>   - **(3)** Make all necessary efforts to maintain and update the information required under paragraph (2) in near real-time fashion and whenever there is a transfer or auction of licenses or change in allocation or assignment.
>   - **(4)** Submit the report required under paragraph (1) to the Committee on Commerce, Science, and Transportation of the Senate and to the Committee on Energy and Commerce of the House of Representatives.
