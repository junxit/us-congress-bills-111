...
- **(3)** over 2/3 of older adults will need some form of long-term care at some point in their lives;
...
- **(9)** States have management information systems that are rarely set up to gather and report basic information about the direct care workforce that could be used to assess changes and challenges to the workforce.
...
## § 4. Direct care workforce data collection and monitoring
...
- **(a)** *In general* The Secretary of Health and Human Services shall establish a direct care workforce monitoring program to—
  ...
  - **(4)** include, at a minium, the collection of direct care workforce data (which may be based on payroll data, taking into account services provided by agency or contract staff) on—
...
## § 5. Direct care worker recruitment, retention, and education grant program
