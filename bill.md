...
- **(5)** the operators of manufactured housing communities should be encouraged to provide a written reminder semiannually to all owners of manufactured homes in the manufactured housing community to replace the batteries in their weather radios; and
- **(6)** weather radio manufacturers should include, in the packaging of weather radios, a written reminder to replace the batteries twice each year and written instructions on how to do so.
