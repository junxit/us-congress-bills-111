...
- **(a)** *Grant application* To be considered for a grant under this Act, an eligible entity shall submit an application to the Secretary that includes the following:
  - **(1)** *Deployment plan* A plan to deploy and provide for the long-term operation and maintenance of intelligent transportation systems to improve safety, mobility, and the environment, such as—
