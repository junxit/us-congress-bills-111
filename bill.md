...
## § 2. Improvement of disability claims processing
...
- **(a)** *Establishment of fast track interim disability ratings* Section 1157 of title 38, United States Code, is amended—
  ...
  - **(2)** by adding at the end the following new subsection:
    > - **(b)** *Fast track interim disability ratings*
    >   - **(1)** In the case of a veteran who submits to the Secretary a claim for compensation under this chapter for more than one condition and the Secretary determines that a disability rating can be assigned without further development for one or more conditions but not all conditions in the claim, the Secretary shall—
    ...
    >   - **(3)**
    >     - **(A)** With respect to an interim disability rating assigned under paragraph (1)(B) for a condition that is rated less than the maximum rate, the Secretary shall continue development of such condition.
