...
This Act may be cited as the “Nurse Training and Retention Act of 2009”.
...
- **(d)** *Additional requirements for healthcare employer described in subsection (c)* To be eligible for a grant under this section, a healthcare employer described in subsection (c) shall demonstrate—
...
- **(f)** *Activities* Amounts awarded to an entity under a grant under this section shall be used for the following:
