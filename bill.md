...
- **(a)** *Short title* This Act may be cited as the “Redistricting Reform Act of 2010”.
...
- **(b)** *Eligibility*
  - **(1)** *Pool of nominees*
    ...
    - **(B)** *Individuals within pool* The Governor shall include an individual within the pool of nominees under this paragraph if—
      - **(i)** the individual submits an application to the Governor for inclusion in the pool, at such time as the Governor may require; and
...
- **(d)** *Deadline*
  - **(1)** *In general* Each State shall establish a commission under this section, and the members of the commission shall appoint the commission’s chair, not later than the first February 1 which occurs after the chief executive of a State receives the State apportionment notice.
...
This Act and the amendments made by this Act shall become effective upon the date of enactment.
