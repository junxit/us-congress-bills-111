...
- **(b)** *Amendments* The amendments referred to in subsection (a) are substantially as follows:
  ...
  - **(4)** Section 18 is amended by adding a new section 18(d) to read as follows:
    > - **(d)**
    >   - **(1)** All payments made by the local Signatory governments for the Authority for the purpose of matching federal funds appropriated in any given year as authorized under title VI, section 601, Public Law 110–432 regarding funding of capital and preventative maintenance projects of 1 the Authority shall be made from amounts derived from dedicated funding sources.
