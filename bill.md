...
- Whereas between ages 45 and 54, men are 3 times more likely than women to die of heart attacks;
...
- Whereas the number of cases of colon cancer among men will reach almost 75,590 in 2009, and almost 1/2 of those men will die from the disease;
- Whereas the likelihood that a man will develop prostate cancer is 1 in 6;
- Whereas the number of men developing prostate cancer in 2009 will reach more than 192,280, and an estimated 27,360 of them will die from the disease;
- Whereas African-American men in the United States have the highest incidence in the world of prostate cancer;
- Whereas significant numbers of health problems that affect men, such as prostate cancer, testicular cancer, colon cancer, and infertility, could be detected and treated if men’s awareness of such problems was more pervasive;
- Whereas more than 1/2 of the elderly widows now living in poverty were not poor before the death of their husbands, and by age 100, women outnumber men 8 to 1;
...
- Whereas appropriate use of tests such as prostate specific antigen exams, blood pressure screenings, and cholesterol screenings, in conjunction with clinical examination and self-testing for problems such as testicular cancer, can result in the detection of many problems in their early stages and increase the survival rates to nearly 100 percent;
