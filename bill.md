...
## § 5. Inventory and determinations

- **(a)** Section 3(a) (16 U.S.C. 1333(a)) is amended as follows:
  - **(1)** By striking “is authorized and directed to” and inserting
    > shall—
    > - **(1)**
  ...
  - **(4)** In paragraph (2) (as so designated)—
    ...
    - **(E)** by striking “desirable. The Secretary shall” and inserting
      > desirable;
      > - **(3)**
...
- **(b)** Subsection (b)(1) of section 3 is amended as follows:
  ...
  - **(5)**
    - **(A)** By inserting “(A)” before “the United States Fish”.
...
- **(d)** In subsection (d) (as so designated) of section 3—
  ...
  - **(4)** by striking “(including” and all that follows through “That, not” and inserting the following:
    > by requiring that—
    > - **(1)** no
