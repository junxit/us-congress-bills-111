...
> ## § 317U. National diabetes prevention program
>
...
>   - **(1)** *Grants for community-based diabetes prevention program model sites for persons at high risk for diabetes* The Secretary may award grants to recognized eligible entities—
>     - **(A)** to support community-based diabetes prevention model sites that work with the health care delivery system—
...
>     - **(B)** to evaluate—
>       - **(i)** methods for ensuring the scalability of recognized community-based diabetes prevention model sites nationally;
...
>   - **(2)** *Recognition program* The Secretary shall develop and implement a program under which the Secretary recognizes, and re-recognizes on an annual basis, eligible entities that deliver community-based diabetes prevention services. To be recognized under this paragraph, an eligible entity shall—
...
>     - **(A)** advances the scalability of recognized community-based diabetes prevention program model sites nationally;
...
>   - **(3)** The term recognized means recognized as provided for under subsection (b)(2).
