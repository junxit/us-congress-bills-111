...
## § 3. Grants for development or implementation of Moving Outdoors in Nature State Strategies
...
- **(b)** *Submission and approval of strategies*
  - **(1)** *Applications* An application for a grant under subsection (a) shall—
...
- **(c)** *Comprehensive strategy requirements* The Secretary may approve a Moving Outdoors in Nature State Strategy under subsection (b)(2) only if the strategy includes the following:
  - **(1)** A description of how the eligible entity will connect children, youth, and families to the outdoors through State and local—
...
- **(d)** *Local planning and implementation*
  - **(1)** *In general* A Moving Outdoors in Nature State Strategy shall provide for—
  ...
  - **(2)** *Program activities* The activities described in this paragraph are the following:
...
- **(h)** *Allocation of funds* An eligible entity receiving a grant under subsection (a) for a fiscal year—
...
## § 4. National strategy for connecting children, youth, and families with the outdoors
...
- **(a)** *In general* Not later than September 30, 2011, the President of the United States, in cooperation with Federal departments and agencies, shall develop and issue a national strategy for connecting children, youth, and families with the outdoors. Such strategy shall include, but not be limited to—
  ...
  - **(3)** coordination of efforts among Federal departments and agencies to address the impacts of children and families spending less time outdoors on—
...
- **(b)** *Strategy development*
  - **(1)** *Participants* In developing the national strategy in subsection (a), the President shall engage—
  ...
  - **(2)** *Public participation* Throughout the process of developing the national strategy in subsection (a), the President shall provide for public participation that includes, but not be limited to—
...
## § 5. National evaluation of health impacts
...
## § 6. Technical assistance and best practices
