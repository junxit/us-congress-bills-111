...
- **(1)** *Heritage area* The term Heritage Area means the Sangre de Cristo National Heritage Area established by section 3(a).
- **(2)** *Management entity* The term management entity means the management entity for the Heritage Area designated by section 3(d).
...
## § 3. Sangre de cristo national heritage area
...
- **(b)** *Requirements* The management plan shall—
  ...
  - **(3)** include—
    - **(A)** an inventory of—
      - **(i)** the resources located in the core area described in section 3(b); and
