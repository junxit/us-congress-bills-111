...
## § 2. Advanced heavy duty hybrid vehicle technology research, development, demonstration, and commercial application program
...
- **(b)** *Applications*
  ...
  - **(2)** *Selection criteria* The Secretary shall establish selection criteria for awarding grants under the program. In evaluating applications, the Secretary shall—
...
- **(c)** *Program requirements; Two phases* Each grant recipient shall be required to complete two phases:
  - **(1)** *Phase one*
    ...
    - **(B)** *Report* Not later than 60 days after the completion of phase one, the recipient shall submit to the Secretary a report containing data and analysis of—
  ...
  - **(2)** *Phase two*
    ...
    - **(B)** *Report* Not later than 60 days after the completion of phase two, the recipient shall submit to the Secretary a report containing—
...
## § 3. Expanding research in hybrid technology for large vehicles
