...
> To amend chapter 83 of title 5, United States Code, to modify the computation for part-time service under the Civil Service Retirement System.

## § 1. Civil service retirement system computation for part-time service
...
The amendment made by section 1 shall take effect on the date of enactment of this Act and apply only with respect to an annuity for which eligibility is based on a separation occurring on or after that date.
