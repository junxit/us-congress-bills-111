...
- **(a)** *In general* Subtitle C of the Solid Waste Disposal Act (42 U.S.C. 6921 et seq.) is amended by adding at the end the following:
  ...
  >   - **(4)** *Federal advisory committee act* The Federal Advisory Committee Act (5 U.S.C. App.) shall not apply to the Board established under this subsection.
  > - **(g)** *Regulations*
  >   - **(1)** *Promulgation*
  ...
  >       - **(ii)** if the manifest is electronically submitted, State authority to access paper printout copiers of the manifest from the system; and
