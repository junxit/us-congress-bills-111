  ...
  - **(2)** in paragraph (8)—
    - **(A)** in subparagraph (B)—
      ...
      - **(ii)** by amending clause (v) to read as follows:
        > - **(v)** the visa overstay rate for nationals of the country during the previous full fiscal year was not more than 10 percent.

    - **(B)** by striking subparagraph (C).

## § 4. Annual report on program compliance
...
## § 5. Termination of designation; probation
...
## § 6. Review of overstay tracking methodology
...
## § 7. Reporting of lost or stolen passports
...
## § 8. Information sharing with law enforcement
