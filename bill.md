...
- **(a)** *In general* Section 3(p) of the Small Business Act (15 U.S.C. 632(p)) is amended—
  ...
  - **(2)** in paragraph (4), by adding at the end the following:
    ...
    >     - **(I)** for which the Administrator determines that the 1-year unemployment rate average is not less than 120 percent of the 1-year average unadjusted unemployment rate for the United States, based on the most recent data available from the Secretary of Labor;
    >     - **(II)** that—
