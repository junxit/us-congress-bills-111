...
- **(10)** *Settlement agreement* The term Settlement Agreement means the contract dated March 31, 2006, between and among—
  ...
  - **(D)** the Taos Valley Acequia Association and its 55 member ditches (“TVAA”);
  - **(E)** the Town of Taos;
  - **(F)** EPWSD; and
...
- **(a)** *In general* The Secretary, acting through the Commissioner of Reclamation, shall provide grants and technical assistance to the Pueblo on a nonreimbursable basis to—
...
- **(d)** *Effect of Section* Nothing in the Settlement Agreement or this Act—
  ...
  - **(4)** waives any claim of a member of the Pueblo in an individual capacity that does not derive from a right of the Pueblo.
- **(e)** *Tolling of claims*
